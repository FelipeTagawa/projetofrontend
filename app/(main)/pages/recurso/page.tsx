            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable
                        ...
                        emptyMessage="Recurso não encontrado."
                        header={header}
                    ...
                    <Dialog visible={recursoDialog} style={{ width: '450px' }} header="Detalhes do recurso" modal className="p-fluid" footer={recursoDialogFooter} onHide={hideDialog}>
                        <div className="field">
                            ...
                            />
                            {submitted && !recurso.nome && <small className="p-invalid">Nome do recurso é obrigatório.</small>}
                        </div>
                        ...
                        <div className="field">
                            ...
                            <InputText
                                ...
                                autoFocus
                                className={classNames({
                                    'p-invalid': submitted && !recurso.login
                                })}
                            />
                    ...
                    <Dialog visible={deleteRecursoDialog} style={{ width: '450px' }} header="Confirmar" modal footer={deleteRecursoDialogFooter} onHide={hideDeleteRecursoDialog}>
                        <div className="flex align-items-center justify-content-center">
                            ...
                            {recurso && (
                                <span>
                                    Tem certeza que deseja excluir o recurso <b>{recurso.nome}</b>?
                                </span>
                            )}
                        </div>
                    </Dialog>
